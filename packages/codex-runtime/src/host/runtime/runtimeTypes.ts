...
export type RuntimeBridgeHandlers = {
  onEvent: (event: NormalizedEvent) => Promise<void> | void;
  onGlobalMessage: (message: ServerInboundMessage) => Promise<void> | void;
  onProtocolError: (error: RuntimeBridgeProtocolError) => Promise<void> | void;
