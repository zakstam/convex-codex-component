...
export default defineSchema({
  ...
  codex_sync_import_jobs: defineTable({
    ...
    .index("userScope_userId_runtimeConversationId_startedAt", ["userScope", "userId", "runtimeConversationId", "startedAt"]),
  ...
  codex_stream_deltas_ttl: defineTable({
    ...
    .index("userScope_streamRef_cursorStart", ["userScope", "streamRef", "cursorStart"])
