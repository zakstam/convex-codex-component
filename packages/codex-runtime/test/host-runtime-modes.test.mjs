...
test("runtime can connect, open thread, and send turn without explicit persistence adapter", async () => {
...
test("runtime factory rejects non-object args", async () => {
  assert.throws(() => createCodexHostRuntime(null), /Runtime factory expects an object argument/);
});
