import type { v2 as CodexProtocolV2 } from "@zakstam/codex-runtime/protocol";
import type { ThreadHandle } from "@zakstam/codex-runtime";
import { canonicalizeSnapshotItemId } from "./snapshotIdentity.js";

type CommandExecutionApprovalDecision = CodexProtocolV2.CommandExecutionApprovalDecision;
type DynamicToolSpec = CodexProtocolV2.DynamicToolSpec;
type FileChangeApprovalDecision = CodexProtocolV2.FileChangeApprovalDecision;
type ProtocolLoginAccountParams = CodexProtocolV2.LoginAccountParams;
type ToolRequestUserInputAnswer = CodexProtocolV2.ToolRequestUserInputAnswer;

export type LoginAccountParams = CodexProtocolV2.LoginAccountParams;
