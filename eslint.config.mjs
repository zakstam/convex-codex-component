...
export default [
  {
    ignores: [
      ...
      "**/dist/**",
      "**/convex/_generated/**",
      "packages/codex-runtime/src/component/_generated/**",
      "**/submodules/**",
      "**/src-tauri/**",
      "**/target/**",
      "**/bundle/**",
  ...
  },
  {
    files: [
      ...
      "packages/codex-runtime/src/**/*.{ts,tsx}",
      "packages/codex-runtime-react/src/**/*.{ts,tsx}",
      "packages/codex-runtime-bridge-tauri/src/**/*.{ts,tsx}",
      "packages/codex-runtime-convex/src/**/*.{ts,tsx}",
    ],
    languageOptions: {
      parser: tsParser,
      parserOptions: {
